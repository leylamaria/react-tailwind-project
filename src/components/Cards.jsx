  ...
  return (
    <div className="bg-white w-full py-[10rem] px-4 ">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full flex flex-col shadow-xl rounded-lg p-4 my-4 hover:scale-105 duration-300 ">
          <img
        ...
        <div className="w-full flex flex-col bg-gray-100 md:my-0 my-8 shadow-xl rounded-lg p-4 hover:scale-105 duration-300 ">
          <img
            className="w-20 mx-auto mt-[-3rem] bg-transperent "
            src={Double}
            alt="/"
          />
